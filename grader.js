...
var checkHtml = function(dom, checks){
    var out = {};
...
var checkHtmlFile = function(htmlfile, checksfile) {
    var dom = cheerioHtmlFile(htmlfile);
    var checks = loadChecks(checksfile).sort();
    return checkHtml(dom, checks);
};
...
var checkHtmlUrl = function(htmlurl, checksfile) {
	...
	if (result instanceof Error) {
	    ...
	    var checkJson = checkHtml(cheerio.load(result), checks);
...
if(require.main == module) {
	...
	console.log("You should provide --file or --url parameter");
    }
